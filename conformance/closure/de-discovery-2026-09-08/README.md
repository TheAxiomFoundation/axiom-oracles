...
The next corrected §64 generation is protected run
...
multiple-recipient cases to be handled separately. No candidate from this run
is declared encoded unless supervised apply and its review gates succeed.
