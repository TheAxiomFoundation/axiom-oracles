...
export async function loadOracleData(basePath = "") {
  ...
  // Report freshness: per-suite report age vs its affected rulespec repos, plus
  // executable-surface staleness alarms. Generated by
  // scripts/check_vacuous_gate.py. Optional — the dashboard renders without it.
  let freshness = null;
  try {
    ...
    // continue without freshness context
  }
