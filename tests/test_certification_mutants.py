...
DE_KINDERGELD_CLOSURE_BLOCKERS = [
    "closed: instrument frontier incomplete — 278 of 770 subordinate/bearing "
    "instruments pending disposition (oracles#491)",
    "closed: dependency closure open — 135 open dependencies (8 law-derived "
    "inputs, 0 unclassified inputs, 127 bearing instruments) (CERTIFIED.md v3)",
]
...
def test_de_certificate_exercise_is_measured_and_closure_is_source_scoped():
    ...
    assert closed["instrument_frontier"]["instrument_count"] == 770
    assert closed["dependency_closure"]["closed"] is False
    assert closed["dependency_closure"]["open_dependency_count"] == 135
...
def test_de_kindergeld_closed_verdict_is_the_ledger_through_the_central_gate():
    ...
    assert closed["rulespec_commit"] == "af3e4f1c15550f8b871a1c14d0a6d1bd7c6a2a41"
