...
DE_KINDERGELD_CLOSURE_BLOCKERS = [
    "closed: instrument frontier incomplete — 291 of 813 subordinate/bearing "
    "instruments pending disposition (oracles#491)",
    "closed: dependency closure open — 165 open dependencies (8 law-derived "
    "inputs, 0 unclassified inputs, 157 bearing instruments) (CERTIFIED.md v3)",
]
...
def test_de_certificate_exercise_is_measured_and_closure_is_source_scoped():
    ...
    assert closed["instrument_frontier"]["instrument_count"] == 813
    assert closed["dependency_closure"]["closed"] is False
    assert closed["dependency_closure"]["open_dependency_count"] == 165
...
def test_de_kindergeld_closed_verdict_is_the_ledger_through_the_central_gate():
    ...
    assert closed["rulespec_commit"] == "212bba29ea06d0166037e4cc24ba4d03b4dd6c02"
