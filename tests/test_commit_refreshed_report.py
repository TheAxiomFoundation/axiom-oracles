...
def test_de_refresh_rebinds_entire_certificate_chain(origin, tmp_path):
    ...
    assert certificate["blockers"] == [
        'closed: instrument frontier incomplete — 18 of 465 subordinate/bearing instruments pending disposition (oracles#491)',
        'closed: dependency closure open — 116 open dependencies (8 law-derived inputs, 0 unclassified inputs, 108 bearing instruments) (CERTIFIED.md v3)',
    ]
