...
def test_de_refresh_rebinds_entire_certificate_chain(origin, tmp_path):
    ...
    assert certificate["blockers"] == [
        'closed: instrument frontier incomplete — 207 of 671 subordinate/bearing instruments pending disposition (oracles#491)',
        'closed: dependency closure open — 127 open dependencies (8 law-derived inputs, 0 unclassified inputs, 119 bearing instruments) (CERTIFIED.md v3)',
    ]
