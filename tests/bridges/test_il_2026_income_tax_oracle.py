...
MODULE = "us-il:policies/income_tax/2026_full_year_resident_core"
...
def test_il_2026_exact_mappings_match_the_rulespec_output_set() -> None:
...
def test_il_2026_core_uses_exact_tax_not_comparable_mappings() -> None:
...
def test_il_2026_core_remains_in_unfiltered_and_tax_coverage(
    tmp_path: Path,
    program: str | None,
) -> None:
    mappings = _module_mappings()
