...
MODULE = "us-fl:policies/income_tax/2026_resident_zero_liability"
...
def test_fl_2026_exact_mappings_match_the_rulespec_output_set() -> None:
...
def test_fl_2026_complete_zero_outputs_use_exact_tax_classifications() -> None:
...
def test_fl_2026_complete_zero_outputs_remain_in_coverage(
    tmp_path: Path,
    program: str | None,
) -> None:
    mappings = _module_mappings()
