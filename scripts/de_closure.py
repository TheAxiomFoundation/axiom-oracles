...
SOURCE_SHA256 = '679ccd6a1df6fc4815ca84a24d819263a6acd5572263da1fec406d4110071a53'

SOURCE_SCHEMA = "axiom_oracles.de_closure_source.v1"
SUMMARY_SCHEMA = "axiom_oracles.de_closure_summary.v1"
RELEASE = 'de-rulespec-2026-09-15-kindergeld-eu-priority-references'
RELEASE_CONTENT_SHA256 = 'af07a408f89956c62368491e60dd762df44a0647eccc7461c5b5060bb96c9464'
RELEASE_SELECTOR_SHA256 = '5a77c1280d36dad176a1d1be2c58995407e3106a51b1f9e829aac9425a1b5e73'
CORPUS_COMMIT = 'aad094d00e42b2766b12393e662473bda81411b0'
...
EXPECTED_INVENTORIES = {
    ...
    'data/corpus/inventory/de/guidance/2026-09-15-de-kindergeld-eu-priority-references.json': ('23a2503915eb4097f39b2a194f5a05e264c6e47346612a2e834cd9fa8240b4c7', 14),
    'data/corpus/inventory/de/guidance/2026-09-15-de-kindergeld-priority-followup.json': ('a2a0ffc6203dedb1f0bceeb8748c134f8841830dde32d689f68437fd33e45282', 8),
    ...
    'data/corpus/inventory/de/regulation/2026-09-10-de-kindergeld-eu-service-earlier.json': ('ba05d92d427205d675f45883b122eec18f665174150d9f17e24bc8e3ffc6074b', 8),
    ...
    'data/corpus/inventory/de/regulation/2026-09-14-de-kindergeld-eu-territory.json': ('a0df67ba2ceb5cbaef5c89db4a2814d8a6b0baf76aacd1fa7cdf84ab388117d5', 6),
    ...
    'data/corpus/inventory/de/statute/2026-09-10-de-kindergeld-generations-service.json': ('4c1a103349b74d5ef4211274a54be1caec625318677f10ec212ae4873e3f17f2', 6),
...
EXPECTED_PROVISION_SOURCES = {
    ...
    'data/corpus/provisions/de/guidance/2026-09-15-de-kindergeld-eu-priority-references.jsonl': ('f5db3cbd0a173a36d38555970ba4c332803706a2fcd3aabb8c9d6cf744f10a6e', 14),
    'data/corpus/provisions/de/guidance/2026-09-15-de-kindergeld-priority-followup.jsonl': ('ede878d9909b89e1f0ae45b549d55129526d0158c32f3e3bca942d34dd99fbed', 8),
    ...
    'data/corpus/provisions/de/regulation/2026-09-10-de-kindergeld-eu-service-earlier.jsonl': ('4218b77f726b7cdbc100cb7911504ba8c12fd631ebe02e1a1897952c7ee0f063', 8),
    ...
    'data/corpus/provisions/de/regulation/2026-09-14-de-kindergeld-eu-territory.jsonl': ('b2795aa6713f2fdc249676c562f5a8fae28a3ccb0a468e0589952b545358d8c6', 6),
    ...
    'data/corpus/provisions/de/statute/2026-09-10-de-kindergeld-generations-service.jsonl': ('e01cf228e16f051022d8fa6974beebeed25c293dc20c9e0e4d0df96fe91a79c0', 6),
...
def _validate_evidence_root(
    ...
    evidence_contracts = {
        ...
        KINDRG_CONTEXT_ROOT: (
            f"{KINDRG_CONTEXT_ROOT}/document-1",
            "de/statute/bgb",
            "KindRG",
        ),
    }
    ...
    if evidence.get("resolution") != "self_and_descendants":
        raise ClosureError(
            f"{label} evidence must resolve by parent-linked descendants"
        )
