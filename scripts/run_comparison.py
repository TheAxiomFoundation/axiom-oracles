...
def _write_dashboard_report(
    ...
    *,
    ...
    if preserve_existing_versioned and committed_report_is_real(target):
        ...
        # against, its run kind and date) with "re-emitted, SHA unknown". The
        # affected rerun then saw the suite as unprovable and re-selected it
        # every sweep. On 2026-09-23 that replaced four real SNAP QC reports.
        print(
