...
EXPECTED_RUNTIME_HELPER_SHA256 = (
    "f1fb4590b2d33afe5e8d87f4dc98974ebdf42ee8623ac7c79521cd266988a618"
)
SMALL_INPUTS = {
    "evaluation_manifest": (
...
def build_receipt(
    *,
    ...
    """Rescan all frozen evaluations and run both real runtimes, without a lock."""
...
def main() -> int:
    ...
    if args.check:
        require(
            ...
            "generated remaining residual receipt missing or stale",
        )
    else:
